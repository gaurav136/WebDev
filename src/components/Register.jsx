                ...
                <div className='flex  items-center  justify-center  w-[500px] h-full m-5 bg-black border-2 border-white rounded-lg'>
                    <div className=' flex  justify-center items-center m-10'>
                        <form className=' w-[400px]' action="">
                            <h1 className='flex justify-center text-white text-[20px] font-bold '>Register</h1>
                            <label className='flex text-white font-semibold' htmlFor="email" >Full Name</label>
                            ...
                            <div className='flex items-center justify-between'>
                                <p className='inline text-white mt-5'>Already register?</p>
                                <Link to='/login'>
                                    <p className='inline   text-white mt-5'>Sign In</p>
                                </Link>
                            </div>  
                        </form>
